<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active">
        <a href="#infoAgency" aria-controls="home" role="tab" data-toggle="tab">Agence Info</a>
    </li>
    <li role="presentation">
        <a href="#manageUsers" aria-controls="profile" role="tab" data-toggle="tab">Gestion d'utilisateurs</a>
    </li>
</ul>
