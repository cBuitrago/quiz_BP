    ...
    (isset($view->is_corpo_admin) && $view->is_corpo_admin === TRUE)
        ...
        <li>
            {if (isset($view->is_group_admin) && $view->is_group_admin === TRUE) }
                ...
                {else}
                    <a href="{$head->baseUrl}/{$smarty.session.accountInfo}/group" {if (isset($view->is_group_active) ) }class="active"{/if}>
                    {/if}
    ...
    (isset($view->is_corpo_admin) && $view->is_corpo_admin === TRUE)
            ...
            <li>
                {if (isset($view->is_agency_admin) && $view->is_agency_admin === TRUE) }
                    ...
                    {else}
                        <a href="{$head->baseUrl}/{$smarty.session.accountInfo}/agency" {if (isset($view->is_agency_active) ) }class="active"{/if}>
                        {/if}
